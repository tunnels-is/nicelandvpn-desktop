...
import { DesktopIcon, FileTextIcon, Pencil2Icon, PersonIcon } from '@radix-ui/react-icons'

import { ForwardToController, ResetEverything, SetConfig, OpenFileDialogForRouterFile } from "../../wailsjs/go/main/Service";
...
const Settings = (props) => {
    ...
    const { inputs, setInputs, user, setUser, UpdateInput, UpdateConfig, Reset, DisableAccount, EnableAccount, UpdateRouterFile, ToggleLogging, ToggleAR, ToggleKS, UpdateUser, ToggleSubscription, autoLogout, ToggleAutoLogout } = useForm(props);
    ...
    return (
        <div className="settings-wrapper">
            ...
            <div className="panel other-panel">
                ...
                {props.state?.LogPath &&
                    <div className="item  extra-space">
                        <div className="title">Log File Path</div>
                        <div className="value">
                ...
                {props.state?.ConfigPath &&
                    <div className="item">
                        <div className="title">Config Backup Path</div>
                        <div className="value">
                            {props.state.ConfigPath}
                        </div>
                    </div>
                ...
                {props.state?.C?.RouterFilePath !== "" &&
                    <div className="item">
                        <div className="title">Router File Path</div>
                        <div className="value">
                            {props.state?.C?.RouterFilePath}
                        </div>
                    </div>
