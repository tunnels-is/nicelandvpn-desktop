...
const useForm = (props) => {
	...
	const [blockedLogging, setBlockedLogging] = useState(false)
	...
	const ToggleBlockedDomainLogging = async () => {
		BlockedDomainLogging(!blockedLogging)
		setBlockedLogging(!blockedLogging)
	}
		...
		<div className="settings-wrapper">
			...
			{props.advancedMode &&
				<div className="panel">
					...
					<div className="item">
						<div className="am toggle-button">
							<label className="switch">
								<input checked={(inputs["DT"] && inputs["DT"].DT) ? true : false} type="checkbox" onClick={() => ToggleCustomDNS()} />
								<span className="slider"></span>
							</label>
							<div className="text">
								Use Custom DNS
			...
			<div className="panel block-panel">
				...
				<div className="item">
					<div className="am toggle-button">
						<label className="switch">
							<input checked={blockedLogging} type="checkbox" onClick={() => ToggleBlockedDomainLogging()} />
							<span className="slider"></span>
						</label>
						<div className="text">
							Log blocked domains
				...
				<div className="item blocking-toggles">
				...
				<div className="item extra-space"></div>
